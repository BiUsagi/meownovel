...
<body>
    ...
    <div id="san-pham" class="none1">
        ...
        <div class="fb-comments" data-href="https://biusagi.github.io/meownovel/index.php" data-width="1400"
            data-numposts="5"></div>
    </div>
    ...
    <div class="new-sp" id="new-sp">
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <p class="tieude"><a>Chào Mừng Đến Với Lớp Học Đề Cao Thực
                    Lực - 03</a></p>
            <div class="gia">
            ...
            <div class="noidung-sp">
                ...
                trường danh giá hàng đầu Nhật Bản, với gần 100% học sinh
                đỗ vào trường đại học mong muốn và tìm được việc làm.
                Học sinh được sử dụng cơ sở vật chất hiện đại bậc nhất,
                mỗi tháng được cấp một số điểm có giá trị tương đương
                100.000 yên, tự do tạo kiểu tóc và mang vật dụng cá
                nhân. Thật giống như sống trên thiên đường.
            </div>
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <div class="noidung-sp">
                ...
                Kirito, Asuna cùng nhóm công phá đã tới tầng 7. Theo dự
                tính lạc quan của Kirito thì với tốc độ hiện thời, cứ
                bảy ngày họ sẽ công phá được một tầng. Còn 93 tầng, theo
                lý thuyết là tầm mùa thu năm 2024 họ sẽ lên tới chóp
                Aincrad, đối mặt với trùm cuối chưa biết tên tuổi hình
                dáng đòn thế thế nào.
            </div>
            <input type="number" value="1" min="1" class="none1">
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <div class="noidung-sp">
                “Tôi”, người chắc chắn đã từng là một nữ sinh cấp ba,
                lúc tỉnh dậy thì lại đang ở một nơi lạ hoắc, đầu thai
                chuyển sinh thành quái vật Nhện!?
                Sau cuộc đào tẩu ngoạn mục thoát khỏi đám Nhện mới nở ăn
                thịt lẫn nhau, tôi lạc vào hang ổ của một đám quái vật.
                Vén màn bí mật về cuộc chiến sinh tồn đang gây sóng gió
                trong cộng đồng mạng của bé Nhện!
            </div>
            <input type="number" value="1" min="1" class="none1">
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <p class="tieude"><a>Vợ Trong Game Của Tôi Là Idol Nổi Tiếng
                    Ngoài Đời - 02</a></p>
            <div class="gia">
            ...
            <div class="noidung-sp">
                Để đáp lại tình cảm toàn tâm toàn ý của Mizuki Rinka,
                tôi, Ayanokouji Kazuto, đã trở thành người yêu của cô
                ấy. Tuy nhiên, là một idol nổi tiếng, cô ấy vô cùng bận
                rộn. Khi những ngày mà chúng tôi chỉ có thể gặp nhau
                trên mạng tiếp tục kéo dài, Rinka đột nhiên đến ngủ lại
                nhà tôi!?
            </div>
            <input type="number" value="1" min="1" class="none1">
    ...
    <input type="button" value="XEM THÊM" class="xtbt" onclick="window.location.href = '/app/views/sanpham2.php'">
    ...
    <div class="new-sp" id="new-sp3">
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <p class="tieude"><a>Arya Bàn Bên Thỉnh Thoảng Lại Trêu Ghẹo
                    Tôi Bằng Tiếng Nga - 01</a></p>
            <div class="gia">
        ...
        <div class="new-spm bg-cl" onmouseover="onboxshad(this)" onmouseout="outboxshad(this)">
            ...
            <p class="tieude"><a>Em là người sống, tôi là người chết.
                    Thế giới đôi lúc lại đảo ngược</a></p>
            <div class="gia">
