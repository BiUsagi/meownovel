...
<div class="boxchungaa">
    <aside id="sanpham4">
        <div class="Muc-as">
            <h3>DANH MỤC</h3>
            <p class="as-av">
                <a href="index.php?controller=sanpham&action=index">TẤT CẢ SẢN PHẨM</a>
            </p>
            <?php for ($i = 0; $i < count($danhmuc); $i++) { ?>
                <p> <a href="index.php?controller=sanpham&action=sptheodm&iddm=<?= $danhmuc[$i]->MaDM; ?>">
