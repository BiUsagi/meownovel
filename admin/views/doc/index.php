...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="/public/images/hay.jpg" width="50px"
                alt="User Image">
            <div>
                <p class="app-sidebar__user-name"><b>SƠN</b></p>
                <p class="app-sidebar__user-designation">Chào mừng bạn trở lại</p>
            </div>
        </div>
        <hr>
        <ul class="app-menu">
            <li><a class="app-menu__item haha" href="/meownovel/index.php"><i class='app-menu__icon bx bx-cart-alt'></i>
            ...
            <li><a class="app-menu__item" href="table-data-user.php"><i
