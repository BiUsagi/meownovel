...
<body onload="time()" class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        ...
        <hr>
        <ul class="app-menu">
            <li><a class="app-menu__item haha" href="/app/views/index.php"><i class='app-menu__icon bx bx-cart-alt'></i>
            ...
            <li><a class="app-menu__item" href="table-data-user"><i class='app-menu__icon bx bx-user-voice'></i><span
