    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form class="row" action="index.php?controller=danhmuc&action=edit" method="post"
                        enctype="multipart/form-data">
                        <div class="form-group col-md-3">
                            <label class="control-label">Mã danh mục</label>
                            <input class="form-control" type="text" name="maDanhMuc" value="<?= $danhmuc->MaDM; ?>"
                                readonly>
                        </div>
                        <div class="form-group col-md-3">
                            <label class="control-label">Tên danh mục</label>
                            <input class="form-control" type="text" name="tenDanhMuc" value="<?= $danhmuc->TenDM; ?>">
                        </div>
