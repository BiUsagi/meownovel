...
// var car = document.querySelector("article");
...
function hide(){
    ...
    document.getElementById("new-sp1").classList.remove("none1")
    document.getElementById("new-sp2").classList.remove("none1")
    document.getElementById("new-sp3").classList.remove("none1")
    document.getElementById("new-sp4").classList.remove("none1")
    // car.removeAttribute("style");
}



// console.log(document.getElementById("san-pham"));
    ...
    for(let i = 0; i< buys.length;i++){
        ...
        buys[i].addEventListener("click",function(){
            ...
            document.getElementById("new-sp1").classList.add("none1");
            document.getElementById("new-sp2").classList.add("none1");
            document.getElementById("new-sp3").classList.add("none1");
            document.getElementById("new-sp4").classList.add("none1")
            // car.setAttribute("style", "height: 1800px;");
